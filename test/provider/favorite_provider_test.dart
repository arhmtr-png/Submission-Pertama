...
void main() {
  ...
  test('Initial load fetches favorites from repository', () async {
    final r = Restaurant(id: '1', name: 'Fav', pictureId: 'p', city: 'C', rating: 5.0);
  ...
  test('addFavorite adds and notifies', () async {
    final r = Restaurant(id: '2', name: 'Add', pictureId: 'p', city: 'C', rating: 4.5);
  ...
  test('removeFavorite removes and notifies', () async {
    final r = Restaurant(id: '3', name: 'Rem', pictureId: 'p', city: 'C', rating: 4.0);
    when(mockRepo.getFavorites()).thenAnswer((_) async => [r]);
