...
void main() {
  testWidgets('Results page displays email and timestamp', (WidgetTester tester) async {
  ...
  await tester.pumpWidget(const SubmissionPertamaApp());
  await tester.pumpWidget(MaterialApp(home: ResultsPage(email: 'jane@example.com', timestamp: '2025-10-03T12:00:00')));
  await tester.pumpAndSettle();
