...
class _FailingRepository extends _FakeRepository {
  @override
  Future<bool> addFavorite(Restaurant restaurant) async => throw Exception('DB error');
}
...
void main() {
  ...
  final r = Restaurant(id: '1', name: 'A', pictureId: 'p1', city: 'X', rating: 4.0);
    ...
    test('handles DB failure gracefully', () async {
      ...
      final provider = FavoriteProvider(repository: repo);
  final r = Restaurant(id: '2', name: 'B', pictureId: 'p2', city: 'Y', rating: 3.5);
