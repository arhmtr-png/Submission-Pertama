...
void main() {
  testWidgets('Settings page has theme toggle and test notification button', (tester) async {
    ...
    final testBtn = find.widgetWithText(ElevatedButton, 'Send Test Notification');
